...
namespace chartex {
    ...
    public partial class Database : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(int Id, int Age, int Total) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public int Total {
                get {
                    try {
                        return ((int)(this[this.tableTable.TotalColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace chartex.DatabaseTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_Age = 1 AND " +
                "[Age] IS NULL) OR ([Age] = @Original_Age)) AND ((@IsNull_Total = 1 AND [Total] I" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [Age], [Total]) VALUES (@Id, @Age, @Total);\r\nSEL" +
                "ECT Id, Age, Total FROM [Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [Age] = @Age, [Total] = @Total WHERE (([Id] = @Original_Id) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)) AND ((@IsNull_Total = 1 AND [Total] IS NULL) OR ([Total] = @Original_Total)));
SELECT Id, Age, Total FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::chartex.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Age, Total FROM dbo.[Table]";
        ...
        public virtual int Fill(Database.TableDataTable dataTable) {
        ...
        public virtual Database.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database.TableDataTable dataTable = new Database.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database.TableDataTable dataTable) {
